...
open class PressableButton: UIButton {
    ...
    public enum Defaults {
        public static var colors = ColorSet(
            button: UIColor(red: 52.0/255.0, green:
                152.0/255.0, blue: 219.0/255.0, alpha: 1.0)
            ,
            shadow: UIColor(red: 41.0/255.0, green:
                128.0/255.0, blue: 185.0/255.0, alpha: 1.0)
        )
        public static var disabledColors = ColorSet(
            button: UIColor(red: 41.0/255.0, green:
                128.0/255.0, blue: 185.0/255.0, alpha: 1.0),
            shadow: UIColor(red: 127.0/255.0, green:
                140.0/255.0, blue: 141.0/255.0, alpha: 1.0)
        )
