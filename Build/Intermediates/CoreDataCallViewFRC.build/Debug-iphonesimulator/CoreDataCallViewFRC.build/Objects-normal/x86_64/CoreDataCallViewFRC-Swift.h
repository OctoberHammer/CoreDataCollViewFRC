...
SWIFT_MODULE_NAMESPACE_PUSH("CoreDataCallViewFRC")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC19CoreDataCallViewFRC11AppDelegate")
...
SWIFT_CLASS_NAMED("InternalData")
@interface InternalData : NSManagedObject
...
SWIFT_CLASS("_TtC19CoreDataCallViewFRC8ItemCell")
...
SWIFT_CLASS("_TtC19CoreDataCallViewFRC6MainVC")
@interface MainVC : UICollectionViewController <NSFetchedResultsControllerDelegate>
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (IBAction)populateCoreData:(UIBarButtonItem * _Nonnull)sender;
...
SWIFT_CLASS("_TtC19CoreDataCallViewFRC7RealmVC")
@interface RealmVC : UICollectionViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (IBAction)populateDataSources:(UIBarButtonItem * _Nonnull)sender;
- (nonnull instancetype)initWithCollectionViewLayout:(UICollectionViewLayout * _Nonnull)layout OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC19CoreDataCallViewFRC6RmItem")
...
SWIFT_CLASS("_TtC19CoreDataCallViewFRC21WithInternalStorageVC")
@interface WithInternalStorageVC : UICollectionViewController <NSFetchedResultsControllerDelegate>
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
